...
VALUES('1e098e28-d9ba-459c-94c7-5508be826c08', '2281', '2021-11-21 10:05:48.198', 'fbfbd90c-4c47-11ec-81d3-0242ac130003', 'external');
INSERT INTO external_reference(parent_id, ref_key, ref_value)
VALUES('1e098e28-d9ba-459c-94c7-5508be826c08', 'key1', 'value1');

-- Entity 2:
INSERT INTO web_message(id, municipality_id, created, party_id, oep_instance)
VALUES('68cd9896-9918-4a80-bb41-e8fe0faf03f9', '2281', '2021-11-22 10:05:48.198', '262f3855-b985-4f3a-a4b8-7b9409ac9590', 'external');
INSERT INTO external_reference(parent_id, ref_key, ref_value)
VALUES('68cd9896-9918-4a80-bb41-e8fe0faf03f9', 'common-key', 'common-value');

-- Entity 3:
INSERT INTO web_message(id, municipality_id, created, party_id, oep_instance)
VALUES('3472ab5b-fca7-4eaf-8eec-8115c9710526', '2281', '2021-11-23 10:05:48.198', 'b7bd0e55-0811-4d3a-91d9-6bab7fd9ce5e', 'external');
INSERT INTO external_reference(parent_id, ref_key, ref_value)
...
-- Entity 7:
INSERT INTO web_message(id, municipality_id, created, party_id, oep_instance)
VALUES('e14264c5-faec-4887-bf8e-e48ce3c2ab0c', '2281', '2023-11-21 10:05:48.198', null, 'external');
INSERT INTO external_reference(parent_id, ref_key, ref_value)
VALUES('e14264c5-faec-4887-bf8e-e48ce3c2ab0c', 'key', 'value');
